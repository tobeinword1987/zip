...
@section('bodyContent')
    ...
    <form role="form" action={{ url('/saveTemplate') }} method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="dropdown">
                        <input class="btn btn-primary dropdown-toggle" type="text" data-toggle="dropdown" name="chooseTemplate" id="chooseTemplate" value="Choose template">
        ...
        <div class="form-group">
            ...
            <div>
                <textarea class="form-control input-sm"  placeholder="Template text" name="editTemplateText" id="editTemplateText">{{ Input::old('editTemplateText') }}</textarea>
            </div>
        </div>
        <div class="row">
